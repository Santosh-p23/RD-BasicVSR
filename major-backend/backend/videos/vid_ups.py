...
MODEL_PATH = VideosConfig.modelpath
SPYNET_PATH =VideosConfig.spynetpath
#give location of images
VAL_LR_PATH = os.path.join(settings.MEDIA_ROOT,'cctv_test')
VAL_HR_PATH = os.path.join(settings.MEDIA_ROOT,'flowvsr')
...
class BasicVSRNet(nn.Module):
    ...
    def __init__(self, mid_channels=64, num_blocks=2, spynet_pretrained=SPYNET_PATH):
...
#you can even change how you save file
                ...
                for fake in fake_curr:
                    ...
                    for img in fake:
                        ...
                        save_image(img, f"{VAL_HR_PATH}/images/hr_{a}.png", normalize=False)
                        j += 1 
